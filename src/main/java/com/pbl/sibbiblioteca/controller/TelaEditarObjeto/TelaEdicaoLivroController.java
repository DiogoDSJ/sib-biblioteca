...
public class TelaEdicaoLivroController {
    ...
    public void setSalvarTituloButton(ActionEvent actionEvent) throws objetoInexistenteException {
        try{
            ...
            TelaController.gerarAlertaOk("Operação realizada", "O título do livro foi trocado. (Necessário reiniciar aba de pesquisa para atualizar)");
        }
    ...
    public void setSalvarIsbnButton(ActionEvent actionEvent) throws objetoInexistenteException, objetoDuplicadoException {
        try {
            ...
            TelaController.gerarAlertaOk("Operação realizada", "O isbn do livro foi trocado. (Necessário reiniciar aba de pesquisa para atualizar)");
        }
        catch (objetoInexistenteException e){
            TelaController.gerarAlertaErro("Livro inexistente.", "Não há livro com esse ISBN.");
        }
    ...
    public void setSalvarAutorButton(ActionEvent actionEvent) throws objetoInexistenteException {
        try {
            ...
            TelaController.gerarAlertaOk("Operação realizada", "O autor do livro foi trocado. (Necessário reiniciar aba de pesquisa para atualizar)");
        }
        catch (objetoInexistenteException e){
            TelaController.gerarAlertaErro("Livro inexistente.", "Não há livro com esse ISBN.");
        }
    ...
    public void setSalvarEditoraButton(ActionEvent actionEvent) throws objetoInexistenteException {
        try {
            ...
            TelaController.gerarAlertaOk("Operação realizada", "A editora do livro foi trocada. (Necessário reiniciar aba de pesquisa para atualizar)");
        }
        catch (objetoInexistenteException e){
            TelaController.gerarAlertaErro("Livro inexistente.", "Não há livro com esse ISBN.");
        }
    ...
    public void setSalvarCategoriaButton(ActionEvent actionEvent) throws objetoInexistenteException {
        try {
            ...
            TelaController.gerarAlertaOk("Operação realizada", "A categoria do livro foi trocada. (Necessário reiniciar aba de pesquisa para atualizar)");
        }
        catch (objetoInexistenteException e){
            TelaController.gerarAlertaErro("Livro inexistente.", "Não há livro com esse ISBN.");
        }
